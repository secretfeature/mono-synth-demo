define([
  ...
  MonoSynth.prototype.setFilterFrequency = function(value){
    ...
    var now = this.audioContext.currentTime,
        ...
        // sampling rate.
        minValue = 40,
        maxValue = this.audioContext.sampleRate / 2,
    ...
    this.filterFrequency = maxValue * multiplier;
    this.filter.frequency.setValueAtTime(this.filterFrequency + this.frequency, now);
